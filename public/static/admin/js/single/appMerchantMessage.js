layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/single/app_merchant_message/");
    //后端接口地址前缀
    window.apiPrefix = facade.compatibleApiRoute("/admin.single.app_merchant_message/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.single.app_merchant_message/index?app_message_id=" + facade.getUrlParam('app_message_id'))
            ...
            , cols: [[
                ...
                , {field: "times", title: "显示时长(秒)", align: "center", width: 120}
