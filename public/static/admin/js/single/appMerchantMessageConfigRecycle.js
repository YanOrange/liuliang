layui.use(['laytp'], function () {
    ...
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/app_merchant_message_config/");
    //后端接口地址前缀
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.single.app_merchant_message_config/recycle")
            ...
            , cols: [[ //表头
                ...
                , {field: "num", title: "消息数量", align: "center", width: 80}
