layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/single/resource_evaluate/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.single.resource_evaluate/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.single.resource_evaluate/index?be_evaluated_id=" + facade.getUrlParam('be_evaluated_id'))
            ...
            , cols: [[
                ...
                , {field: "resource_title", title: "所属资源", align: "center", width: 150}
                ...
                , {
                    field: 'sort', title: '排序', align: 'center', width: 80, templet: function (d) {
                        return laytpForm.tableForm.editInput('sort', d, '/admin.single.resource_evaluate/setSort');
                    }
                }
