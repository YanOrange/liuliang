layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/single/course_two/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.single.course_two/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.single.course_two/index")
            ...
            , cols: [[
                ...
                , {field: "entry_fee", title: "课程价格", align: "center",width: 180}
                , {
