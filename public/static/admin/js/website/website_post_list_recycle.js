layui.use(['laytp'], function () {
    ...
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/website/website_post_list");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.website.website_post_list/");
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.website.website_post_list/recycle")
            ...
            , cols: [[ //表头
                ...
                , {field: "post_name", title: "岗位名称", align: "center"}
                , {
