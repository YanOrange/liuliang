layui.use(['laytp'], function () {
    ...
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/website/website_style_show");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.website.website_style_show/");
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.website.website_style_show/recycle")
            ...
            , cols: [[ //表头
                ...
                , {field: "delete_time", title: "删除时间", align: "center", width: 160}
                , {
                    field: 'operation',
                    title: '操作',
