layui.use(['laytp'], function () {
    ...
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/external_user/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.external_user/");
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.external_user/recycle")
