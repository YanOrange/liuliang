layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/wx_user_thread/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.wx_user_thread/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.wx_user_thread/index")
            ...
            , cols: [[
                ...
                , {
                    field: "is_media", title: "是否新媒体", align: "center", width: 100, templet: function (d) {
                        return laytpForm.tableForm.switch("is_media", d, {
                            "open": {"value": 1, "text": "是"},
                ...
                , {field:'is_sms',title:'是否发短信',align:'center',templet:function(d){
                        return laytp.tableFormatter.status('is_sms',d.is_sms,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
                ...
                , {
                    field: "customer_qrcode", title: "客服二维码", align: "center", templet: function (d) {
                        return laytp.tableFormatter.images(d.customer.qr_code);
                    }
                }
        ...
        layui.table.on("toolbar(laytp-table)", function (obj) {
            ...
            if (defaultTableToolbar.indexOf(obj.event) !== -1) {
                ...
                switch(obj.event) {
                    case "exportThread":
                        window.location.href = '/admin.wx_user_thread/exportThread';
                        break;
                }
            }
        });
        ...
        layui.table.on('edit(laytp-table)', function (obj) {
            ...
            facade.ajax({
                route:'/admin.wx_user_thread/setWxNickname',
