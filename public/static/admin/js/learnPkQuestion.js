layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/learn_pk_question/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.learn_pk_question/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.learn_pk_question/index")
            ...
            , cols: [[
                ...
                , {field: "question_title", title: "问题名称", align: "center", width: 200}
