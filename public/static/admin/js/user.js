    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {
                    field: "department_id", title: "所属部门", align: "center", templet: function (d) {
                        if (d.department) {
                            return d.department.department_name;
                        }
                        return '-';
                    }
                }
                ...
                , {
                    field: "is_show_phone", title: "是否显示完整手机号", align: "center", templet: function (d) {
                        if (d.id === 1) {
                            return (d.is_show_phone === 1) ? "是" : "否";
                        } else {
                            return laytpForm.tableForm.switch("is_show_phone", d, {
                                "open": {"value": 1, "text": "是"},
