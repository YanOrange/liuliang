layui.use(["laytp"], function () {
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.app_for_flow/index")
            ...
            , cols: [[
                ...
                , {field: "app_names", title: "关联应用", align: "center"}
                , {field: "register_nums", title: "填写人数", align: "center"}
                , {
                ...
                , {field: "operation", title: "操作", align: "center", fixed: 'right', toolbar: "#default-bar", width: 360}
            ]]
        });
            ...
            if (defaultTableTool.indexOf(obj.event) !== -1) {
                ...
                switch(obj.event){
                    case "data-analysis-list":
                        ...
                        break;
                    case "custom-problem-list":
                        facade.popupDiv({
                            title: "自定义问题",
                            path: "/admin/app_for_flow/custom_problem_list.html?id=" + obj.data.id
                        });
                        break;
                }
