layui.use(['laytp'], function () {
    ...
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/user_agreement/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.user_agreement/");
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.user_agreement/recycle")
