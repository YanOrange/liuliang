layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/distribution_collection_order/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.distribution_collection_order/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.distribution_collection_order/index")
            ...
            , cols: [[
                ...
                , {field: "pay_total_amount", title: "支付总额", align: "center", width: 100}
