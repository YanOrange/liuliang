layui.use(['laytp'], function () {
    ...
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/vivo_data_origin/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.vivo_data_origin/");
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.vivo_data_origin/recycle")
            ...
            , cols: [[ //表头
                ...
                , {
                    field: "src_id", title: "数据源id", align: "center"
                }
