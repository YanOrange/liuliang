layui.use(['laytp'], function () {
    ...
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/personal_transfer_agreement/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.personal_transfer_agreement/");
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.personal_transfer_agreement/recycle")
            ...
            , cols: [[ //表头
                ...
                , {field: "channel_names", title: "关联渠道", align: "center"}
