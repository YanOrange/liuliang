layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/delivery_mode/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.delivery_mode/");
    ...
    funController.tableRender = function (where) {
        ...
        laytpTreeTable = layui.treeTable.render({
            ...
            , url: facade.url("/admin.delivery_mode/index",{is_tree:1})
            , where: where
            , method: "GET"
