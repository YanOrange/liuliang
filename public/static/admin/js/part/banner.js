layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/part/banner/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.part.banner/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.part.banner/index")
            ...
            , cols: [[
                ...
                ,{field:'sort',title:'排序',align:'center', width: 100,templet:function(d){
                        return laytpForm.tableForm.editInput('sort',d,'/admin.part.banner/setSort');
                    }}
