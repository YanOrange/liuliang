layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/part/part_course/");
    //后端接口地址前缀
    window.apiPrefix  = facade.compatibleApiRoute("/admin.part.part_course/");
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.part.part_course/index")
            ...
            , cols: [[
                ...
                , {field: "app_class_id", title: "类目", align: "center", width: 120, templet:'<div>{{# if(d.class){ }}{{d.class.app_class_name}}{{# }else{ }}-{{# } }}</div>'}
                ...
                , {
                    field: "is_allow_apply", title: "是否产生线索", align: "center", width: 120, templet: function (d) {
                        return laytpForm.tableForm.switch("is_allow_apply", d, {
                            "open": {"value": 1, "text": "是"},
