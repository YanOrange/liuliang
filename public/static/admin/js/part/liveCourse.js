layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/part/live_course/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            elem: "#laytp-table"
            , id: "laytp-table"
            , url: facade.url("/admin.part.live_course/index")
            ...
            , cols: [[
                ...
                , {field: "entry_fee", title: "售卖价", align: "center", width: 100}
                ...
                , {field: "live_time", title: "直播时间", align: "center", width: 300}
                , {field: "live_status", title: "直播状态", align: "center", width: 120}
                ,{field:'sort',title:'排序',align:'center', width: 100,templet:function(d){
                        return laytpForm.tableForm.editInput('sort',d,'/admin.part.live_course/setSort');
                    }}
                , {
