    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
				...
				,{field:'sel_admin_id',title:'选择后台管理员',align:'center',templet:'<div>{{# if(d.selAdminUser){ }}{{d.selAdminUser.nickname}}{{# }else{ }}-{{# } }}</div>'}
				...
				,{field:'hobby',title:'爱好（复选框）',align:'center',templet:function(d){
