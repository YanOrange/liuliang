layui.use(['laytp'], function () {
    ...
    funRecycleController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , url: facade.url("/admin.merchant_recharge_detail/recycle")
            ...
            , cols: [[ //表头
                ...
                , {field: "recharge_amount", title: "充值金额", align: "center", width: 120}
                , {field: "merchant_id", title: "商户名称", align: "center",templet:'<div>{{# if(d.merchant){ }}{{d.merchant.merchant_name}}{{# }else{ }}-{{# } }}</div>'}
                , {field: "operate_id", title: "操作人", align: "center",templet:'<div>{{# if(d.operator){ }}{{d.operator.nickname}}{{# }else{ }}-{{# } }}</div>'}
