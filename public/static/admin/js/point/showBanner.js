layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/show_banner/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {field: "operation_type", title: "操作类型", align: "center", width: 150, templet: function (d) {
                        return laytp.tableFormatter.status('operation_type',d.operation_type,{"value":["0","1","2"],"text":["无","滑动","点击"]}, true);
                    }}
                , {field: "rotation_chart_url", title: "轮播图url", align: "center",width:150}
