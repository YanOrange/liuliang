layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/landing/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {field: "last_event_id", title: "上一个事件", align: "center",templet:'<div>{{# if(d.event){ }}{{d.event.event_name}}{{# }else{ }}-{{# } }}</div>'}
                , {field: "slide_bottom", title: "页面是否滑动底部", align: "center", width: 150, templet: function (d) {
                        return laytp.tableFormatter.status('slide_bottom',d.slide_bottom,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
                ...
                , {field: "video_play_total_time", title: "视频总时长", align: "center",width:150}
                , {field: "video_click_nums", title: "视频点击播放/暂停次数", align: "center",width:150}
                , {field: "video_play_nums", title: "视频播放次数", align: "center",width:150}
                , {field: "click_receive_button", title: "点击立即领取按钮次数", align: "center",width:150}
                , {field: "click_close_button", title: "点击关闭按钮", align: "center", width: 150, templet: function (d) {
                        return laytp.tableFormatter.status('click_close_button',d.click_close_button,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
                , {field: "close_time", title: "退出时间", align: "center",width:150}
                ...
                , {field: "landing_page_id", title: "落地页ID", align: "center",width:150}
                , {field: "browse_duration", title: "浏览时长(s)", align: "center",width:150}
                , {field: "btn_text", title: "按钮文案", align: "center",width:150}
