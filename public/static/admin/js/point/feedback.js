layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/feedback/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {field: "feedback_id", title: "反馈内容", align: "center",width: 150,templet:'<div>{{# if(d.feedback){ }}{{d.feedback.content}}{{# }else{ }}-{{# } }}</div>'}
                , {field: "contact", title: "联系方式", align: "center",width: 150,templet:'<div>{{# if(d.feedback){ }}{{d.feedback.phone}}{{# }else{ }}-{{# } }}</div>'}
