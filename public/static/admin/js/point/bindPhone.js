layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/bind_phone/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {field: "login_status", title: "是否登录成功", align: "center", width: 150, templet: function (d) {
                        return laytp.tableFormatter.status('login_status',d.login_status,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
