layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/user_agreement/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {field: "agreement_status", title: "是否同意协议", align: "center", width: 150, templet: function (d) {
                        return laytp.tableFormatter.status('agreement_status',d.agreement_status,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
