layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/course_detail/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {field: "is_slide", title: "页面是否滑动", align: "center", width: 150, templet: function (d) {
                        return laytp.tableFormatter.status('is_slide',d.is_slide,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
                , {field: "is_slide_bottom", title: "页面是否滑动底部", align: "center", width: 150, templet: function (d) {
                        return laytp.tableFormatter.status('is_slide_bottom',d.is_slide_bottom,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
                , {field: "last_page_id", title: "上一个页面", align: "center",width: 150,templet:'<div>{{# if(d.page){ }}{{d.page.page_name}}{{# }else{ }}-{{# } }}</div>'}
