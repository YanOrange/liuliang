layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/my_page/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , done: function(res){
                if(res.data[0].event.event_id == 'event_setting_exit' || res.data[0].event.event_id == 'event_setting_logout' || res.data[0].event.event_id == 'event_setting' || res.data[0].event.event_id == 'event_my_feedback' || res.data[0].event.event_id == 'event_my_course' || res.data[0].event.event_id == 'event_my_edit'){
                    $("[data-field='browse_duration']").css('display','none');
                }
