layui.use(["laytp"], function () {
    const funController = {};
    //静态页面地址前缀
    window.htmlPrefix = facade.compatibleHtmlPath("/admin/point/wx_auth_btn/");
    //后端接口地址前缀
    ...
    funController.tableRender = function (where, page) {
        layui.table.render({
            ...
            , cols: [[
                ...
                , {field: "wx_authorization_status", title: "是否微信授权成功", align: "center", width: 160, templet: function (d) {
                        return laytp.tableFormatter.status('wx_authorization_status',d.wx_authorization_status,{"value":["0","1"],"text":["否","是"]}, true);
                    }}
