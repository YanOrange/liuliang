...
layui.define([
    ...
    laytpForm.initData = {
         ...
         *      data-showChoiceBtn="false"//非必设，是否显示选择附件按钮，默认true
        ...
        upload: function (parentElem) {
            ...
            layui.each(obj, function (key, item) {
                ...
                let options = {
                    ...
                    , showChoiceBtn: typeof $(item).data("showchoicebtn") === "undefined" || $(item).data("showchoicebtn") === false
                ...
                if (options.uploadedCallback) options.params.uploadedCallback = options.uploadedCallback;
                ...
                if (options.viaServer === 'via') {
                    ...
                    if (options.type === 'ali-oss' || options.type === 'ali-oss-url') {
