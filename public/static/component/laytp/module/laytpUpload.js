            ...
            layui.upload.render({
                ...
                choose: function (obj) {
                    ...
                    if (options.uploadedCallback) {
                        if (typeof window[options.uploadedCallback] === "function") {
                            window[options.uploadedCallback].call(this, res.data);
                        } else {
                            facade.error(options.uploadedCallback + "回调函数未定义");
                        }
                    }
                                        ...
                                        progress: function (p) {
                                            ...
                                            if (p === 1) {
                                                facade.ajax({
                                                    ...
                                                    alert(options.uploadedCallback);
                                                    if (options.uploadedCallback) {
