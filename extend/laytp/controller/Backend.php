...
class Backend extends BaseController
{
    ...
    //公共的验证方法
    protected function commonValidate($params, $class, $scene)
    {
        $validate = new $class;
            ...
            foreach ($searchParam as $field => $valueCondition) {
                if ($valueCondition['value'] !== '') {
                    ...
                    switch ($condition) {
                       ...
                       //     $arrBetween[0] = strtotime($arrBetween[0]) !== false && strtotime($arrBetween[0]) != -1 ? strtotime($arrBetween[0]) : $arrBetween[0];
                         //   $arrBetween[1] = strtotime($arrBetween[1]) !== false && strtotime($arrBetween[1]) != -1 ? strtotime($arrBetween[1]) : $arrBetween[1];
