...
class TLSSigAPIv2 {
    ...
    */
    ...
    private function base64_url_encode( $string ) {
        ...
        if ( $base64 === false ) {
            return false;//throw new \Exception( 'base64_encode error' );
        }
    ...
    */
    ...
    private function __genSig( $identifier, $expire, $userbuf, $userbuf_enabled ) {
        ...
        if ( $json_str_sig === false ) {
            return false;//throw new \Exception( 'json_encode error' );
        }
        $compressed = gzcompress( $json_str_sig );
        if ( $compressed === false ) {
            return false;//throw new \Exception( 'gzcompress error' );
        }
