 ...
 *
 * This file includes the referenced bin path (../yurunsoft/pay-sdk/src/Weixin/Tool/CertificateDownloader.php) using ob_start to remove the shebang if present
...
$binPath = __DIR__ . "/" . '../yurunsoft/pay-sdk/src/Weixin/Tool/CertificateDownloader.php';
