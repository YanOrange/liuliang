...
use app\validate\admin\extrathreadconfig\ExtraThreadConfig as ExtraThreadConfigValidate;
 ...
 * 后台轮播图控制器
 */
class ExtraThreadConfig extends Backend
{
    protected $model;//当前模型对象
    protected function _initialize()
    {
        $this->model = new \app\model\admin\ExtraThreadConfig();
    }
    //查看
    public function index()
    {
        ...
        $data = $this->model->where($where)->with(['channel' => function($query){
    ...
    public function add()
    {
        ...
        $validate = new ExtraThreadConfigValidate();
    ...
    public function recycle()
    {
        ...
        $data  = $this->model->onlyTrashed()
            ->order($order)->where($where)->with(['channel' => function($query){
                $query->field('id,channel_name');
