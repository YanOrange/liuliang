...
use app\validate\admin\articlenews\ArticleNews as ArticleValidate;
 ...
 * 后台推荐阅读控制器
 */
class ArticleNews extends Backend
{
    protected $model;//当前模型对象
    protected function _initialize()
    {
        $this->model = new \app\model\admin\ArticleNews();
    }
    //查看
    ...
    public function add()
    {
        ...
        $post['theme_images'] = str_replace(',',', ',$post['theme_images']);
        Db::startTrans();
        try {
