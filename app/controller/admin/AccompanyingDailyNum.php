...
use app\validate\admin\accompanying\AccompanyingDailyNum as AccompanyingDailyNumValidate;
 ...
 * 后台应用分类控制器
 */
class AccompanyingDailyNum extends Backend
{
    protected $model;//当前模型对象
    protected function _initialize()
    {
        $this->model = new \app\model\admin\AccompanyingDailyNum();
    }
    //查看
    ...
    public function add()
    {
        ...
        Db::startTrans();
        try {
            $post['wechat_num'] = $post['learn_num'] + $post['visit_num'] + $post['unknown_num'];
