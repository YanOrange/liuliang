...
use app\validate\admin\personaltransferagreement\PersonalTransferAgreement as PersonalTransferAgreementValidate;
 ...
 * 后台个人信息授权传输协议控制器
 */
class PersonalTransferAgreement extends Backend
{
    protected $model;//当前模型对象
    protected function _initialize()
    {
        $this->model = new \app\model\admin\PersonalTransferAgreement();
    }
    //查看
    ...
    public function add()
    {
        ...
        $validate = new PersonalTransferAgreementValidate();
    ...
    public function edit()
    {
        ...
        Db::startTrans();
        try {
            $personalTransferAgreement = $this->model->findOrEmpty($post['id']);
            if (!$personalTransferAgreement) throw new \Exception('id参数错误');
            $updateRes  = $personalTransferAgreement->update($post);
