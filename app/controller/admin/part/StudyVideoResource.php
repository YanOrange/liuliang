...
use app\validate\admin\part\StudyVideoResource as StudyVideoResourceValidate;
 ...
 * 后台学习资源控制器
 */
class StudyVideoResource extends Backend
{
    protected $model;//当前模型对象
    protected function _initialize()
    {
        $this->model = new \app\model\admin\part\StudyVideoResource();
    }
    //查看
    ...
    public function add()
    {
        ...
        $validate = new StudyVideoResourceValidate();
    ...
    public function edit()
    {
        ...
        Db::startTrans();
        try {
            $studyVideoResource = $this->model->findOrEmpty($post['id']);
            if (!$studyVideoResource) throw new \Exception('id参数错误');
            $updateRes  = $studyVideoResource->update($post);
