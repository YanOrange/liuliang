...
use app\validate\admin\website\WebsitePostList as WebsitePostListValidate;
use think\facade\Db;
 ...
 * 后台职位控制器
 */
class WebsitePostList extends Backend
{
    protected $model;//当前模型对象
    protected function _initialize()
    {
        $this->model = new \app\model\admin\website\WebsitePostList();
    }
    //查看
    ...
    public function add()
    {
        ...
        $validate = new WebsitePostListValidate();
