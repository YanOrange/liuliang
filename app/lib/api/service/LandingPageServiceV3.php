...
use app\lib\api\service\MerchantServiceV3;
class LandingPageServiceV3
{
    ...
    {
        extract($params);
        $merchantParam = MerchantServiceV3::getMerchantIsPayCount($params);
        ...
        $courseData = MerchantServiceV3::sortMerchantList($merchantParam, $params,$landingPageId);
